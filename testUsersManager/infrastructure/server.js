...
var translationsManager = require('./translationsManager');
...
var server = function () {
	...
	app.use(require('./authorization/authModule').onRequestStart);
	...
	//db initialization
	require('./dbConnection').dbInit(config.dbConnectionString);
